...
PostCons = pd.read_csv('data/PostconditionsWTechDescr.csv', header=None).to_numpy()
PreCons = pd.read_csv('data/PreconditionsWTechDescr.csv', header=None).to_numpy()

PostDI = PostCons[Postinds]
PreDI = PreCons[Preinds]
